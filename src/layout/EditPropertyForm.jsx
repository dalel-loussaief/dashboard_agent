...
const EditPropertyForm = () => {
  ...
  useEffect(() => {
    const fetchProperty = async () => {
      try {
        const response = await axios.get(`http://localhost:8000/Property/property-detail/${id}/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:8000/Property/property-update/${id}/`, formData);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.inputGroup}>
            ...
            {editedProperty.image && (
              <img src={`http://localhost:8000/Property${editedProperty.image}`} alt="Property Image" style={{ maxWidth: "100%", marginTop: "10px" }} />
            )}
          </div>
          <div style={styles.inputGroup}>
